<template>
  <div class="full">
    ...
    >
      ...
      <el-table-column label="拔管信息查看" fixed="right" width="200">
...
<script>
import { getPatientsExtubation } from '@/api/record';
...
export default {
  ...
  methods: {
    ...
    // 获取用户列表信息
    initList() {
      getPatientsExtubation({
        query: this.query,
        pagenum: this.pagenum,
        pagesize: this.pagesize
      }).then((res) => {
        this.patientList = res.data.patientsExtubation;
